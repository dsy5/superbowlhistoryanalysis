...
total_points <- total_points%>%
  mutate(year_ints_by_5 = case_when(
    ...
    (Date < 1996 & Date > 1990) ~ "1990-95",
    (Date < 2001 & Date > 1995) ~ "1995-00",
    (Date < 2006 & Date > 2000) ~ "2000-05",
    (Date < 2011 & Date > 2005) ~ "2005-10",
    (Date < 2016 & Date > 2010) ~ "2010-15",
    (Date < 2021 & Date > 2015) ~ "2015-20",
  ))%>%
